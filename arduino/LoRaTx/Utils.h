...
{
    //111535.00,151015,N5130.87919,W00011.62597,77.938,G3,13,0.214,8.76,4,0
  //152437.00,151015,N5130.88101,W00011.63540,68.701,G3,9.7,0.099,3.12,6,0
  //235947.00,120136,N0000.00000,E00000.00000,0.000,NF,5303301,0.000,99.99,0,0
  //211502.00,100180,N0000.00000,E00000.00000,0.000,NF,5303301,0.000,99.99,0,0
  //
  
  /*
  uBlox.sTime ="235535.00";
  uBlox.sDate="151016";
  uBlox.NS="N";
...
//  uBlox.Alt = "0000" + String(fTemp, 3);  // pad string, use 3 digits after the decimal point
//  uBlox.Alt = uBlox.Alt.substring(uBlox.Alt.length() - 8); // use the rightmost 8 characters
